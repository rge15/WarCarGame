...
Hexadecimal [16-Bits]
   ...
   410B 43 50 43 74 65 6C    31 string: .asciz "CPCtelera up and running!";
        65 72 61 20 75 70
        20 61 6E 64 20 72
        75 6E 6E 69 6E 67
        21 00
                             ...
                             46 .globl cpct_setDrawCharM1_asm
                             47 .globl cpct_drawStringM1_asm
                             48 
                             49 ;;
                             50 ;; MAIN function. This is the entry point of the application.
                             51 ;;    _main:: global symbol is required for correctly compiling and linking
                             52 ;;
   4000                      53 _main::
                             54    ;; Disable firmware to prevent it from interfering with string drawing
   4000 CD 91 40      [17]   55    call cpct_disableFirmware_asm
                             56 
                             57    ;; Set up draw char colours before calling draw string
   4003 16 00         [ 7]   58    ld    d, #0         ;; D = Background PEN (0)
   4005 1E 03         [ 7]   59    ld    e, #3         ;; E = Foreground PEN (3)
                             60 
   4007 CD B6 40      [17]   61    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             62 
                             63    ;; Calculate a video-memory location for printing a string
   400A 11 00 C0      [10]   64    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   400D 06 18         [ 7]   65    ld    b, #24                  ;; B = y coordinate (24 = 0x18)
   400F 0E 10         [ 7]   66    ld    c, #16                  ;; C = x coordinate (16 = 0x10)
                             67 
   4011 CD A2 40      [17]   68    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             69 
                             70    ;; Print the string in video memory
                             71    ;; HL already points to video memory, as it is the return
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 85.
Hexadecimal [16-Bits]



                             72    ;; value from cpct_getScreenPtr_asm
   4014 FD 21 0B 41   [14]   73    ld   iy, #string    ;; IY = Pointer to the string 
                             74 
   4018 CD 1D 40      [17]   75    call cpct_drawStringM1_asm  ;; Draw the string
                             76 
                             77    ;; Loop forever
   401B                      78 loop:
   401B 18 FE         [12]   79    jr    loop
